...
409 9 ~TextFont 0 6 814 19 TextFont::~TextFont 0 0 10
/**
 *
 */
34
...
427 15 DynamicTextPage 0 4 820 32 DynamicTextPage::DynamicTextPage 0 1 33 10
/**
 *
 */
75
...
428 16 ~DynamicTextPage 0 4 820 33 DynamicTextPage::~DynamicTextPage 0 0 0
40
...
443 15 DynamicTextFont 0 4 822 32 DynamicTextFont::DynamicTextFont 0 3 39 40 41 324
/**
...
444 16 ~DynamicTextFont 0 6 822 33 DynamicTextFont::~DynamicTextFont 0 0 10
/**
 *
 */
48
...
498 9 ~FontPool 0 4 833 19 FontPool::~FontPool 0 0 0
26
...
500 14 StaticTextFont 0 4 836 30 StaticTextFont::StaticTextFont 0 1 99 374
/**
...
502 15 ~StaticTextFont 0 4 836 31 StaticTextFont::~StaticTextFont 0 0 0
38
StaticTextFont::~StaticTextFont(void);

503 14 TextProperties 0 4 837 30 TextProperties::TextProperties 0 2 101 102 22
/**
 *
 */
...
594 15 ~TextProperties 0 4 837 31 TextProperties::~TextProperties 0 0 0
38
TextProperties::~TextProperties(void);

595 11 TextGraphic 0 4 846 24 TextGraphic::TextGraphic 0 4 196 197 198 199 34
/**
 *
 */
...
602 12 ~TextGraphic 0 4 846 25 TextGraphic::~TextGraphic 0 0 0
32
...
613 13 TextAssembler 0 4 850 28 TextAssembler::TextAssembler 0 2 218 219 22
/**
 *
 */
...
615 14 ~TextAssembler 0 4 850 29 TextAssembler::~TextAssembler 0 0 10
/**
 *
 */
36
...
658 8 TextNode 0 4 854 18 TextNode::TextNode 0 2 262 263 184
/**
 *
 */
...
659 9 ~TextNode 0 6 854 19 TextNode::~TextNode 0 0 10
/**
 *
 */
34
...
33 0 0 7 54 819 428 0 0 1 6 param0 0 877  
...
39 0 0 7 72 882 444 0 10 /**
 *
 */ 1 4 copy 1 880  
40 0 0 7 72 882 444 0 173 /**
 * The constructor expects the name of some font file that FreeType can read,
 * along with face_index, indicating which font within the file to load
 * (usually 0).
 */ 2 13 font_filename 1 883  10 face_index 1 808  
41 0 0 7 72 882 444 0 137 /**
 * This constructor accepts a table of data representing the font file, loaded
 * from some source other than a filename on disk.
 ...
 * coordinate system in which this model was generated.  "up" in this
 * coordinate system will be the direction of the top of the letters.
 */ 2 8 font_def 1 889  2 cs 1 861  
100 0 0 7 160 867 0 0 0 0 
101 0 0 7 165 891 594 0 10 /**
 *
 */ 0 
102 0 0 7 165 891 594 0 10 /**
 *
 */ 1 4 copy 1 892  
 ...
 *
 */ 3 4 this 3 892  3 out 1 871  12 indent_level 1 808  
...
199 0 0 7 284 899 602 0 0 1 6 param0 0 904  
 ...
 *
 */ 3 4 this 3 908  3 out 1 871  12 indent_level 1 808  
217 0 0 6 307 907 0 0 74 /**
 * Returns the pointer to the global TextPropertiesManager object.
 */ 0 
218 0 0 7 309 912 615 0 10 /**
 *
 */ 1 4 copy 1 910  
 ...
 *
 */ 3 4 this 3 918  3 out 1 871  12 indent_level 1 808  
...
832 6 Format 0 794624 15 Texture::Format 15 Texture::Format 821 0 0 0 0 0 0 0 0 0 46 15 F_depth_stencil 24 Texture::F_depth_stencil 0
